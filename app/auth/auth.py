...
from app.utils.security import verify_password, create_access_token, create_verification_token
...
def verify_email(token: str, db: Session = Depends(get_db)):
    try:
        email = verify_token(token)  # 'verify_token' valida el token de verificación
